...
**Depends on:** Cumulative PFD design through `0098`; PFD Finance and Accounting Domain Specification
...
Next: **PFD Workforce and Payroll Domain Specification**. Executable Finance and Accounting SQL remains deferred until PFD leaves Design Land.
