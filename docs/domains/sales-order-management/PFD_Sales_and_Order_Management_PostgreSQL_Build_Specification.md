...
**Depends on:** Cumulative PFD design through `0068`; PFD Sales and Order Management Domain Specification
...
Next: **PFD Transportation and Delivery Domain Specification**. Executable Sales and Order Management SQL remains deferred until PFD leaves Design Land.
