...
**Depends on:** Cumulative PFD design through `0126`; PFD Workforce and Payroll Domain Specification

## 1. Purpose

Define the normalized PostgreSQL structures, natural keys, constraints, controlled operations, privileges, views, audit, and verification required to support PFD Workforce and Payroll. This document specifies the future build package but contains no executable SQL.
...
Next: **PFD Quality, Food Safety, and Recall Domain Specification**. Executable Workforce and Payroll SQL remains deferred until PFD leaves Design Land.
