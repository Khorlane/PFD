# Public Sample and Private Configuration Decision
...
Source code, database schema changes, design specifications, tests, and repository history must not contain real personal names, private business identity, private street addresses, credentials, financial identifiers, or other private operating data.
